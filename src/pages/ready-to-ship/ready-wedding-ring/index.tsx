...
const ReadyWeddingRing: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-wedding-ring';
    ...
    const productSubURL = `${paths.readyToShip.root}/ready-wedding-ring`
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-wedding-ring' as string;
...
export default ReadyWeddingRing;
