...
const ReadyPendants: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-pendants';
    ...
    const productSubURL = `${paths.readyToShip.root}/ready-pendants`
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-pendants' as string;
