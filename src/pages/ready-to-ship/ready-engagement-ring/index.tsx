...
const ReadyEngagementRing: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-engagement-ring';
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-engagement-ring' as string;
...
export default ReadyEngagementRing;
