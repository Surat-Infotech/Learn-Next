...
const ReadyToShip: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-to-ship';
    ...
    const productSubURL = `${paths.readyToShip.root}`
        ...
        <>
            ...
            <div className='min-h-454'>
                <ProductSubCategoryView
                    heading="Ready To Ship Diamonds, Rings and Fine Jewelry"
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-to-ship' as string;
