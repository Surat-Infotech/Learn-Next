...
const ReadyChains: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-chains';
    ...
    const productSubURL = `${paths.readyToShip.root}/ready-chains`
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-chains' as string;
