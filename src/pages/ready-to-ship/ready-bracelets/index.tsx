...
const ReadyBracelets: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-bracelets';
    ...
    const productSubURL = `${paths.readyToShip.root}/ready-bracelets`
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-bracelets' as string;
