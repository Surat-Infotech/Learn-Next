...
const ReadyEarrings: NextPage<InferGetServerSidePropsType<typeof getServerSideProps>> = () => {
    const categorySlug = 'ready-earrings';
    ...
    const productSubURL = `${paths.readyToShip.root}/ready-earrings`
...
export const getServerSideProps = withSsrProps({
    ...
    prefetch: async ({ q, ctx }) => {
        const categorySlug = 'ready-earrings' as string;
