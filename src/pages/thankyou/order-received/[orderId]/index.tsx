...
const OrderThankYouPage = () => {
  ...
  const { data, isLoading } = useQuery(orderQuery.get(query?.orderId as string));
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Thank you for your purchase! We appreciate your business and look forward to serving you again. For any queries or support, feel free to contact us"
        />
      </Head>
      {/* new design */}
      {
        !isLoading && orderData !== null && (
          <div className="order_confirmation_section pb-0 py-sm-4 pb-lg-5">
            ...
            <div className="thankyou_page">
              <div className="header-section text-center">
                <div className="d-flex justify-content-center">
                  ...
                  <h3 className="text-capitalize ms-1">{`${orderData.customer_schema?.name?.split(' ')?.[0]}`}</h3>
                </div>
                <h6 className="mb-0">
                  Order <span>#{orderData?.order_no}</span>
                </h6>
              </div>
            </div>
            <div className="order_confirmation_deatil">
              ...
              <div
                className={orderData && orderData?.order_notes?.[0]?.message ? 'my_50' : 'mb_50'}
              >
                <div className="container-fluid px-0">
                  <div className="row">
                    <div className="col-sm-6">
                      <div className="shipping_address">
                        <span className="d-block mb_20" style={{ color: '#777' }}>
                          Shipping Address
                        </span>
                        <span className="">
                          {orderData.address_schema?.shipping?.first_name}{' '}
                          {orderData.address_schema?.shipping?.last_name}
                          <br />
                          {orderData.address_schema?.shipping?.address}
                          <br />
                          {orderData.address_schema?.shipping?.address_second &&
                            orderData.address_schema?.shipping?.address_second}
                          {orderData.address_schema?.shipping?.address_second && <br />}
                          {orderData.address_schema?.shipping?.city}
                          {', '}
                          {orderData.address_schema?.shipping?.postcode}{' '}
                          <br className="d-none d-sm-block" />
                          {orderData.address_schema?.shipping?.state}
                          {orderData.address_schema?.shipping?.state && ', '}
                          {orderData.address_schema?.shipping?.country}
                          <br />
                          <br className="d-none d-sm-block" />
                          <i className="fa-solid fa-phone" />{' '}
                          {orderData.address_schema?.shipping?.phone}
                          <br />
                          <i className="fa-solid fa-envelope" />{' '}
                          {orderData.address_schema?.shipping?.email}
                        </span>
                      </div>
                    ...
                    <div className="col-sm-6">
                      <div className="shipping_address">
                        ...
                        <span className="">
                          {' '}
                          {orderData.address_schema?.billing?.first_name}{' '}
                          {orderData.address_schema?.billing?.last_name}
                          <br />
                          {orderData.address_schema?.billing?.address}
                          <br />
                          {orderData.address_schema?.billing?.address_second &&
                            orderData.address_schema?.billing?.address_second}
                          {orderData.address_schema?.billing?.address_second && <br />}
                          {orderData.address_schema?.billing?.city}{' '}
                          {orderData.address_schema?.billing?.postcode}{' '}
                          <br className="d-none d-sm-block" />
                          {orderData.address_schema?.billing?.state}
                          {orderData.address_schema?.billing?.state && ', '}
                          {orderData.address_schema?.billing?.country}
                          <br className="d-none d-sm-block" />
                          <br />
                        </span>
                      </div>
              ...
              <div className="product_detail">
                                      ...
                                      ? `${item.diamond_schema.shape?.replaceAll('_', ' ')} Shape ${
                                          ...
                                          item.diamond_schema.intensity
                                            ? colorDaimondFilters.find(
                                                (_c) =>
                                                  _c.defaultValue ===
                                                  Number(item?.diamond_schema?.color)
                                              )?.color
                                            : colorFilters.find(
                                                (_c) =>
                                                  _c.value === Number(item?.diamond_schema?.color)
                                              )?.label_view
                                        } Color ${
                                          clarityFilters.find(
                                            (_c) =>
                                              _c.value === Number(item?.diamond_schema?.clarity)
                                          )?.label_view
                                    ...
                                    item.product_schema.product_type !== 'diamond' ? (
                                      <>
                                        ...
                                        <p className="m-0 text-capitalize ">
                                          ...
                                          <span>
                                            {item.variation_schema?.name?.[0].value.replaceAll(
                                              '-',
                                              ' '
                                            )}
                                          </span>
                                        ...
                                        <p className="mb-0">
                                          {item.variation_schema?.name.length > 1 && (
                                            <>
                                              ...
                                              <span>{item.variation_schema?.name?.[1]?.value?.replace(/[-_]/g, '.')}</span>
                                            </>
                                          )}
                                        </p>
                                        {item.back_setting && (
                                        ...
                                        {item.product_schema?.engraving_details?.text?.length >
                                          0 && (
                                          <p className="mb-0">
                                            <span className="text_black_secondary ">
                                              Engraving Text:{' '}
                ...
                <div className="total_box">
                  <div className="">
                    <div className="d-flex align-items-center justify-content-between">
                      ...
                      <p className="fw-medium"> ${orderData.order_base_price as number}</p>
                    </div>
                    <div className="d-flex align-items-center justify-content-between">
                    ...
                    {orderData?.extra_charges !== 0 && (
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <p className="fw-medium">
                          ...
                          $
                          {Number(
                            orderData.extra_charges || orderData?.orderData?.extra_charges
                          ).toFixed(2)}
                        </p>
                      </div>
                    )}
                    {orderData.discount !== 0 && (
                      <div className="d-flex align-items-center justify-content-between">
                        ...
                        <p className="green_text">- ${Number(orderData.discount).toFixed(2)}</p>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="d-flex align-items-center justify-content-between">
                    ...
                    <p className="fw-bold mb-0">
                      $
                      {(orderData.order_base_price as number) +
                        Number(orderData.shipping_cost) +
                        Number(orderData.extra_charges) -
                ...
                <p className="track_text">
                  ...
                  Additionally you can <span className="fw-bold">track your order.</span> We
