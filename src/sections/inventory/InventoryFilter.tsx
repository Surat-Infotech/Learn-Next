...
const InventoryFilter = () => {
  ...
  const [showAllShape, setShowAllShape] = useState(false);
  ...
  const [_totalWhiteDiamond, _setTotalWhiteDiamond] = useLocalStorage<number>('totalDiamond', 0);
  ...
  const handleSearchText = () => {
    ...
    if (trimmedSearch.length > 0) {
      ...
      if (window.location.search.includes('c_type')) {
        setCollectionSearchSku(data.trim());
      }
      ...
      setTimeout(() => {
        if (
          ...
          setCarat([range.carat.min, range.carat.max] as any);
  ...
  }, [resetSearchText, search, setResetSearchText, setSearchText]);

  useEffect(() => {
    if ((query.sku && !query.c_type) || !!(query.type && query.shape && !query.c_type)) {
  ...
  // for reset filter of diamond collection page
  useEffect(() => {
  ...
  useEffect(() => {
    if ((query.type || query.c_type) && !query.shape && !shape && !searchText && !search) {
      ...
      if ((query.shape as string)?.length > 0 && query.shape === __shape) {
  ...
  useEffect(() => {
    if (collectionSearchSku && (query.type || query.c_type)) setSearch(collectionSearchSku);
  }, [collectionSearchSku, query.c_type, query.type]);
  ...
  useEffect(() => {
    if (
      ...
      _setTotalWhiteDiamond(totalDiamond);
  }, [_setTotalWhiteDiamond, query.type, query.c_type, totalDiamond, appliedFilters]);
  ...
  useEffect(() => {
    if (query.Slug && query.c_type && diamondCollectionReset) {
      setCollectionSearchSku('');
      setSearchText('');
      setSearch('');
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [query.Slug, diamondCollectionReset]);
  ...
  useEffect(() => {
    const timeoutId = setTimeout(() => {
      ...
      if (Number(lwratio[0]) < range.lw_ratio.min || Number(lwratio[0]) > range.lw_ratio.max) {
        setLWRatio([range.lw_ratio.min, Number(lwratio[1])]);
      }
      if (Number(lwratio[1]) < range.lw_ratio.min || Number(lwratio[1]) > range.lw_ratio.max) {
    ...
    <>
      <div className="container-fluid">
        ...
        <div className="d-none d-lg-block">
          <div className="inventory-filter-section row align-items-center">
            {/* Shape filter */}
            <div className="col-xxl-4 col-lg-6">
              <div className="d-flex align-items-center mb_50 shape">
                ...
                <div className="slider-box d-flex align-items-center w-100 diamond-filter ps-0 ps-xxl-3 pe-0 pe-xxl-1">
                  <div className="d-flex align-items-center flex-column gap-4 w-100">
                    ...
                    {showAllShape && (
                      <div className="d-flex align-items-center justify-content-between flex-wrap flex-xl-nowrap more-shape w-100">
                        {shapeFilters.slice(10, 20).map((shapeFilter) => (
                          <FilterShape
                            key={shapeFilter.id}
                            {...shapeFilter}
                            shapeMatch={shapeMatch}
                  ...
                  {!showAllShape && (
                    ...
                    <div className="more" onClick={() => setShowAllShape(true)}>
            ...
            {/* Price filter */}
            <div className="col-xxl-4 col-lg-6">
              <div className="d-flex align-items-center mb_50">
            ...
            <div className="col-xxl-4 col-lg-6">
              <div className="d-flex align-items-start mb_70">
                ...
                <div className="w-100 pe-4 pe-xxl-0 ps-lg-2 ps-xxl-0">
                  <TRangeSlider
                    minRange={1}
                    showLabelOnHover={false}
                    min={1}
            ...
            <div className="col-xxl-4 col-lg-6">
              <div className="d-flex align-items-start mb_70">
                <div className="heading d-flex align-items-center">
                  <p className="mb-0 lh-1">Color</p>
                  <TTooltip
                    label="Diamond Color measures the degree of colorlessness. Stones are graded on a scale that ranges from D (colorless) to Z (yellow)."
                    w={300}
                  >
                    <span className="question_icon ms-1">
                      <i className="fa-solid fa-question" />
                ...
                <div className="w-100 pe-4 pe-xxl-0">
                  <TRangeSlider
                    minRange={1}
                    min={1}
                    showLabelOnHover={false}
                    max={colorFilters.length}
                    step={1}
                    value={color as any}
                    onChange={(newValue) => {
                      setColor(newValue);
                    ...
                    marks={colorFilters}
                    // label={(val) => colorFilters[val - 1].label}
                    label={() => null}
                    className="color-slider-handles w-100 slider-box"
                  />
                  <div className="inventory-filter-text d-flex align-items-center justify-content-around mt-2">
                    <span>M</span>
                    <span>L</span>
            ...
            <div className="col-xxl-8 col-xl-6">
              <div className="d-flex align-items-center">
                ...
                <div className="d-flex align-items-center flex-wrap gap-2 ps-3">
                  {/* Hearts And Arrow Filter */}
                  {shape?.length > 0 && shape?.length === 1 && shape[0] === 'round' && (
                    <div>
                      <button
                        type="button"
                        onClick={() => {
                          setHeartsAndArrows(!heartsAndArrows);
                          setKeepSkuuSearch(false);
                          setNotFetchFilter(false);
                          setIsFilterLoading(true);
                        }}
                        className={heartsAndArrows ? 'heart_arrow_btn h-a-bg' : 'heart_arrow_btn'}
                      >
                        H&A
                      </button>
                    </div>
        ...
        <div className="filter_resultsec">
          <form>
            <div className="d-flex align-items-center flex-wrap">
              <div className="d-flex filter-button-group gap-2">
                ...
                <div className="d-flex align-items-center serch_input_inventory">
                  <input
                    ...
                    value={search ?? searchText ?? collectionSearchSku}
                    onChange={(e) => {
              ...
              <div className="d-flex align-items-center justify-content-between justify-content-lg-start  extra-shipping-box-container gap-3 ms-lg-3">
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (window.location.search.includes('?sku=')) {
                      router.replace({ pathname: window.location.pathname }, undefined, {
                        scroll: false,
                        shallow: true,
                      });
                    }
