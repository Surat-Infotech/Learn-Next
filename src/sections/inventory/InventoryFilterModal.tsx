...
import { transformValue, reverseTransformValue } from '@/components/common-functions';

import { paths } from '@/routes/paths';
import LoadingImage from '@/assets/image/Loading.gif';

import FilterShape from './FilterShape';
import style from './InventoryFilterModal.module.css';
...
const InventoryFilterModal: FC<InventoryFilterModalProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <Accordion className="filter-accordion" defaultValue="Shape">
        <Accordion.Item value="Shape">
          ...
          <Accordion.Panel className="spacing-content px_0">
            <div className="d-flex align-items-center w-100">
              <div className="d-flex align-items-center flex-column w-100">
                <div className="pb-4 flex-xl-nowrap w-100 shapefilter">
                  {shapeFilters.slice(0, 20).map((shapeFilter) => (
                    <FilterShape
                      key={shapeFilter.id}
                      {...shapeFilter}
                ...
                {/* {showAllShape && ( */}
                {/* <div className="d-flex align-items-center justify-content-between flex-wrap pb-4 flex-xl-nowrap w-100 shapefilter">
        ...
        <Accordion.Item value="Price">
          ...
          <Accordion.Panel className="spacing-content">
            ...
            <div className="mt-2">
              <div className="w-100">
                <TRangeSlider
                  ...
                  label={() => null}
                  marks={cutFilters}
                  className="cut-slider-handles w-100"
                />
            ...
            <div className="mt-2">
              <div className="w-100">
                <TRangeSlider
                  ...
                  label={() => null}
                  className="color-slider-handles w-100"
                />
                <div className="inventory-filter-text d-flex align-items-center justify-content-around mt-2">
                  <span>M</span>
                  <span>L</span>
                ...
                <Popover zIndex={1200} width={200} position="bottom" withArrow shadow="md">
                  ...
                  <Popover.Dropdown className="filter-tooltip filter-tooltip2">
                    <Text size="xs">
                      ...
                      scale that ranges from D (colorless) to Z (yellow).
                    </Text>
                  </Popover.Dropdown>
                </Popover>
              </div>
            ...
            <div className="mt-2">
              <div className="w-100">
                <TRangeSlider
                  ...
                  label={() => null}
                  className="clarity-slider-handles w-100 z-0"
                />
                <div className="inventory-filter-text d-flex align-items-center justify-content-around mt-2">
                  <span>I2</span>
                  <span>I1</span>
        ...
        {!query?.c_type && (
          <Accordion.Item value="Type">
            ...
            <Accordion.Panel>
              <div className="inventory-type-button mb-1">
                <button
                  type="button"
                  className={clsx(
                    'small_btn',
        ...
        <div className="d-flex align-items-start flex-wrap gap-2 my-2 my-sm-3">
          ...
          {shape?.length > 0 && shape?.length === 1 && shape[0] === 'round' && (
            ...
            //   <button
            //     type="button"
            //     onClick={() => setHeartsAndArrows(!heartsAndArrows)}
            ...
            <Group className="certificate-filter-checkbox align-items-start mt-2 gap-12">
              <Checkbox
                // @ts-ignore
                value={heartsAndArrows}
                checked={heartsAndArrows}
                onChange={() => {
                ...
                label="Hearts and Arrows Diamonds"
                color="black"
              />
            </Group>
          )}
                    ...
                    <Popover zIndex={1200} width={200} position="bottom" withArrow shadow="md">
                      ...
                      <Popover.Dropdown className="filter-tooltip">
                        <Text size="xs">
                          ...
                          accounts for around 40-60% of the diamond&lsquo;s total weight. This
                          portion plays a crucial role in enhancing the stone’s overall brilliance
